"""Unit tests for agentp_shared core modules."""
import pytest
...
class TestErrors:
    def test_all_error_codes_defined(self):
        from agentp_shared.errors import ErrorCode
        expected = [
    ...
    def test_error_status_map_covers_all_codes(self):
        from agentp_shared.errors import ErrorCode, ErrorStatusMap
...
class TestResponses:
    def test_ok_response(self):
        from agentp_shared.responses import ok_response
...
class TestSecurity:
    ...
    def test_create_and_decode_refresh_token(self):
        from agentp_shared.security import create_refresh_token, decode_token
...
class TestSchemas:
    def test_request_context(self):
        from agentp_shared.schemas import RequestContext
...
class TestConfig:
    def test_service_urls(self):
        from agentp_shared.config import GATEWAY_PORT, AUTH_URL, HOST_URL, SCHEDULER_URL
...
class TestServiceClient:
    ...
    async def test_service_client_headers(self):
        from agentp_shared.service_client import ServiceClient
...
class TestRedis:
    def test_get_redis_is_coroutine(self):
        import inspect
        from agentp_shared.redis import get_redis, close_redis
